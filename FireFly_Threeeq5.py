...
class FireFly:
    ...
    def __init__(self):
        ...
        self._dimen=3                 #dimensão do problema
    ...
    def set_pontos(self):
        ...
        n1=uniform(0,self._limites[0])
        n2=uniform(0,self._limites[1]) 
        n3=uniform(0,self._limites[2])  
        _pt=array([n1,n2,n3])
        return _pt    
...
#    def set_limites(self):
#        self._limites=array([0.5,500.,0.5])
#        return self._limites
    ...
    def set_populacao_inicial(self,_p_dimen,_p_qtdff):
        ...
        for i in range(_p_qtdff):               #criar quantidade de fireflies definida...
            ...
            self._fFlies.append(self.set_pontos())
